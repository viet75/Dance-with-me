  ...
  appleWebApp: {
    ...
    startupImage: [
      ...
      },
      {
        ...
        media:
          "(device-width: 1104px) and (device-height: 1470px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)",
      },
      {
        url: "/splash/11__iPad_Pro_M4_landscape.png",
        media:
          "(device-width: 1104px) and (device-height: 1470px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)",
      },
      {
